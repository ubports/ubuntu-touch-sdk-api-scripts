...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SEOExtension'
        db.create_table(u'developer_portal_seoextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['developer_portal.SEOExtension'])),
            ('extended_object', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Title'], unique=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'developer_portal', ['SEOExtension'])


    def backwards(self, orm):
        # Deleting model 'SEOExtension'
        db.delete_table(u'developer_portal_seoextension')
    ...
    models = {
        ...
        u'developer_portal.seoextension': {
            'Meta': {'object_name': 'SEOExtension'},
            'extended_object': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.Title']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywords': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'public_extension': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'draft_extension'", 'unique': 'True', 'null': 'True', 'to': u"orm['developer_portal.SEOExtension']"})
        },
        u'sites.site': {
