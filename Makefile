...
update-common: collectstatic
	...
	if [ $(DATABASE_URL) ]; then ./update_apidocs.sh > /srv/devportal-app-0/logs/update_apidocs.log; fi
...
crontab:
	...
	@echo "* 0 * * * cd /srv/devportal-app-0/code/latest/; ./update_apidocs.sh > /srv/devportal-app-0/logs/update_apidocs.log" >> crontab
	#@crontab ./crontab
...
collectstatic.done:
	...
	@python manage.py collectstatic -v 2 --noinput --settings charm_settings 2>/dev/null
